...
export const FilePreviewModalView = withStyles(fileViewStyles)(({ classes, file, onClearForm, errors = [] }: FilePreviewModalProps) => (
	return (<Modal open={this.state.open} onClose={this.handleClose}>
		<ModalWrap>
