...
export const FileVideoIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '29px', height: props.height || '36px' } }, props, { viewBox: props.viewBox || '0 0 29 36' }),
