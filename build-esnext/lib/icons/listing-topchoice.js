...
export const ListingTopChoiceIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '21px', height: props.height || '21px' } }, props, { viewBox: props.viewBox || "0 0 21 21" }),
