...
export const MarketplaceMenuIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '15px', height: props.height || '16px' } }, props, { viewBox: props.viewBox || "0 0 15 16" }),
