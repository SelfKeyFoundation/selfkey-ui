...
export const MenuHelpIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '16px', height: props.height || '19px' } }, props, { viewBox: props.viewBox || '0 0 16 19' }),
