...
export const PersonIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '46px', height: props.height || '46px' } }, props, { viewBox: props.viewBox || "0 0 46 46" }),
