...
export const TickIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '11px', height: props.height || '9px' } }, props, { viewBox: props.viewBox || '0 0 11 9' }),
