...
export const UnlockIcon = withStyles(styles)((props) => (React.createElement(SvgIcon, Object.assign({ style: { width: props.width || '14px', height: props.height || '18px' } }, props, { viewBox: props.viewBox || '0 0 14 18' }),
