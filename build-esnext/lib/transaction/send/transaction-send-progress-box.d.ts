...
}, "address" | "locale" | "cryptoCurrency" | "closeAction" | "status" | "openLink" | "amount" | "transactionHash"> & import("@material-ui/core").StyledComponentProps<"button" | "address" | "actionButtonsContainer" | "amountContainer" | "amount" | "button2" | "sentTo">>;
