...
export declare const TransactionHistory: React.ComponentType<Pick<StyledProps, "list" | "openLink"> & import("@material-ui/core").StyledComponentProps<"flex" | "row" | "icon" | "line" | "date" | "value" | "cryptoCurrency" | "status" | "actionTitle" | "viewActionContainer" | "copyActionContainer">>;
export {};
