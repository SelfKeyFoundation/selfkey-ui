...
exports.AddressBook = styles_1.withStyles(styles)(function (_a) {
    var classes = _a.classes, addresses = _a.addresses, onEdit = _a.onEdit, onDelete = _a.onDelete, onAdd = _a.onAdd;
    return (React.createElement(core_1.Grid, { container: true, direction: "column", justify: "center", alignItems: "center", className: classes.addressBook, spacing: 2 },
        React.createElement(core_1.Grid, { item: true },
