...
exports.DashboardMenuIcon = react_jss_1.default(styles)(function (props) { return (React.createElement(core_1.SvgIcon, __assign({ style: { width: props.width || '24px', height: props.height || '24px' } }, props, { viewBox: props.viewBox || "0 0 24 24" }),
...
exports.default = exports.DashboardMenuIcon;
