...
exports.ExchangeNewIcon = react_jss_1.default(styles)(function (props) { return (React.createElement(core_1.SvgIcon, __assign({ style: { width: props.width || '34px', height: props.height || '34px' } }, props, { viewBox: props.viewBox || "0 0 34 34" }),
    React.createElement("g", { id: "\uD83D\uDDA5-Main-Dashboard-exchange-new", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" },
        React.createElement("g", { id: "300.9-transactions-list-exchange-new", transform: "translate(-327.000000, -578.000000)" },
            React.createElement("g", { id: "Modal-exchange-new", transform: "translate(268.000000, 153.000000)" },
                React.createElement("g", { id: "Area-Body-exchange-new" },
