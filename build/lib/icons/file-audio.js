...
exports.FileAudioIcon = core_1.withStyles(styles)(function (props) { return (React.createElement(core_2.SvgIcon, __assign({ style: { width: props.width || '29px', height: props.height || '36px' } }, props, { viewBox: props.viewBox || '0 0 29 36' }),
