...
export var LedgerIcon = function (props) { return (React.createElement(SvgIcon, __assign({ style: { width: props.width || '25px', height: props.height || '25px' } }, props, { viewBox: "0 0 25 25" }),
