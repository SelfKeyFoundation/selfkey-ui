...
var ListIcon = function (props) { return (React.createElement(core_1.SvgIcon, __assign({ style: { width: props.width || '32px', height: props.height || '16px' } }, props, { viewBox: props.viewBox || '0 0 32 16' }),
