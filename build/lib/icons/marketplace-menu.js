...
export var MarketplaceMenuIcon = withStyles(styles)(function (props) { return (React.createElement(SvgIcon, __assign({ style: { width: props.width || '15px', height: props.height || '16px' } }, props, { viewBox: props.viewBox || "0 0 15 16" }),
