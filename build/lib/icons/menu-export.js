...
export var MenuExportIcon = withStyles(styles)(function (props) { return (React.createElement(SvgIcon, __assign({ style: { width: props.width || '17px', height: props.height || '20px' } }, props, { viewBox: props.viewBox || "0 0 17 20" }),
