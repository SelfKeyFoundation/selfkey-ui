...
export var MenuHelpIcon = withStyles(styles)(function (props) { return (React.createElement(SvgIcon, __assign({ style: { width: props.width || '16px', height: props.height || '19px' } }, props, { viewBox: props.viewBox || "0 0 16 19" }),
