...
function ModalCloseIcon() {
    return (React.createElement("div", { style: { height: '38px', marginLeft: '779px', marginTop: '-20px', position: 'absolute', width: '38px', cursor: 'pointer' } },
        React.createElement("svg", { viewBox: "0 0 38 38" },
            React.createElement("g", { id: "Symbols", stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" },
                React.createElement("g", { id: "Close-button", transform: "translate(1.000000, 1.000000)" },
                    React.createElement("g", { id: "icon-close-modal" },
                        ...
                        React.createElement("g", { transform: "translate(9.000000, 9.000000)", fill: "#23E6FE", "fill-rule": "nonzero", id: "Shape" },
...
exports.default = ModalCloseIcon;
