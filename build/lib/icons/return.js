...
exports.ReturnIcon = core_1.withStyles(styles)(function (props) { return (React.createElement(core_2.SvgIcon, __assign({ style: { width: props.width || '15px', height: props.height || '18px' } }, props, { viewBox: props.viewBox || '0 0 15 18' }),
