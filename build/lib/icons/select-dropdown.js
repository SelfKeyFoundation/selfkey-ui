...
exports.SelectDropdownIcon = react_jss_1.default(styles)(function (props) { return (React.createElement(core_1.SvgIcon, __assign({ style: { width: props.width || '18px', height: props.height || '10px' } }, props, { viewBox: props.viewBox || "0 0 18 10" }),
