...
exports.SentNewIcon = react_jss_1.default(styles)(function (props) { return (React.createElement(core_1.SvgIcon, __assign({ style: { width: props.width || '34px', height: props.height || '34px' } }, props, { viewBox: props.viewBox || "0 0 34 34" }),
    React.createElement("g", { id: "Main-Dashboard-sent-new-icon", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" },
        React.createElement("g", { id: "300.7-dashboard-alternate1--sent-new-icon", transform: "translate(-1048.000000, -536.000000)" },
