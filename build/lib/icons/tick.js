...
exports.TickIcon = core_1.withStyles(styles)(function (props) { return (React.createElement(core_2.SvgIcon, __assign({ style: { width: props.width || '11px', height: props.height || '9px' } }, props, { viewBox: props.viewBox || '0 0 11 9' }),
