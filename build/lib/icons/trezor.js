...
export var TrezorIcon = function (props) { return (React.createElement(SvgIcon, __assign({ style: { width: props.width || '18px', height: props.height || '25px' } }, props, { viewBox: "0 0 18 25" }),
