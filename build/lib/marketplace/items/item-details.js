        ...
        return requirements.map(function (requirement, index) {
            return (React.createElement(core_1.ListItem, { className: classes.requirementListItem },
                ...
                requirement.type === 'document' &&
                    React.createElement(document_1.DocumentIcon, null)));
        });
    };
                        ...
                        React.createElement(core_1.Grid, { item: true, id: 'description' },
                            React.createElement(core_1.Grid, { container: true, direction: 'row', justify: 'center', alignItems: 'flex-start', spacing: 40 },
                                React.createElement(core_1.Grid, { item: true, xs: 8 },
                                    ...
                                    React.createElement(core_1.Button, { variant: "outlined", className: classes.button + " " + classes.buttonDescription, onClick: function () { return _this.handleViewAllDetails(); } }, (this.state.isDescriptionTruncated) ? 'VIEW ALL DETAILS' : 'COLLAPSE DETAILS')),
                                React.createElement(core_1.Grid, { item: true, xs: 4 },
                                    React.createElement(styled_button_1.StyledButton, { onClick: function () { return _this.unlockActionCall(unlockAction, item, hasBalance); } },
                                        item.status === 'Active' &&
