...
exports.FileUploadLabel = core_2.withStyles({
    root: {
        alignItems: 'center',
        cursor: 'pointer',
        display: 'flex',
...
exports.FileUploadInput = core_2.withStyles({
    root: {
        display: 'none',
    },
})(core_1.Input);
exports.DecimalInput = core_2.withStyles({
    input: {
        textAlign: 'right'
    },
})(core_1.Input);
...
exports.FileUploadGrid = core_2.withStyles({
    container: {
