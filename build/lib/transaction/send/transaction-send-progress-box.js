...
export var TransactionSendProgressBox = withStyles(styles)(function (_a) {
    ...
    return (React.createElement(TransactionBox, { cryptoCurrency: cryptoCurrency, closeAction: closeAction },
