...
export const ModalBox = withStyles(styles)((props: ModalBoxProps & WithStyles<typeof styles>) => (
    <Grid container className={props.classes.root} direction='column' justify='flex-start' alignItems='flex-start'>
        <Grid item id='header' className={props.classes.header}>
            <Typography variant="h2">{props.headerText}</Typography>
            <button className={props.classes.closeButton} onClick={props.closeAction}><CloseButtonIcon/></button>
        </Grid>
