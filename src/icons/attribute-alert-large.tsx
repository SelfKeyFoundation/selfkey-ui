...
export const AttributeAlertLargeIcon = withStyles(styles)(
	(props: SvgIconProps & WithStyles<typeof styles>) => (
		<SvgIcon
			style={{ width: props.width || '38px', height: props.height || '44px' }}
			{...props}
			viewBox={props.viewBox || '0 0 38 44'}
		>
			<g
				id="💻-ID-Dashboard-attribute-large-icon"
				stroke="none"
				strokeWidth="1"
				fill="none"
				fillRule="evenodd"
			>
				<g
					id="410.1-Marketplace-Applications-Statuses"
					transform="translate(-195.000000, -379.000000)"
					fill="#E98548"
				>
