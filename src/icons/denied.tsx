...
export const DeniedIcon = withStyles(styles)((props: SvgIconProps & WithStyles<typeof styles>) => (
	...
	>
		...
		<g
			id="💻-ID-Dashboard-icon-denied-ma"
			stroke="none"
			strokeWidth="1"
			fill="none"
			fillRule="evenodd"
		>
			<g
				...
				transform="translate(-1188.000000, -940.000000)"
				fill="#FE4B61"
			>
