...
export const ExchangeRoundedIcon = injectSheet(styles)<SvgIconProps>((props: SvgIconProps & StyledComponentProps) => (
        <SvgIcon style={{ width: props.width || '34px', height: props.height || '34px' }} {...props} viewBox={props.viewBox || "0 0 34 34"}>
            <g id="🖥-Main-Dashboard-exchange-rounded" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="300.9-transactions-list-exchange-rounded" transform="translate(-327.000000, -578.000000)">
