...
export const ExistingAddressIcon = (props: SvgIconProps) => (
	<SvgIcon
		style={{ width: props.width || '28px', height: props.height || '25px' }}
		{...props}
		viewBox={props.viewBox || '0 0 28 25'}
	>
		<defs></defs>
		<g id="🛠-Wallet-Setup" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
			<g
				id="111---Import-Keystore-File-(UTC)"
				transform="translate(-346.000000, -399.000000)"
				fill="#23E6FE"
				fillRule="nonzero"
			>
