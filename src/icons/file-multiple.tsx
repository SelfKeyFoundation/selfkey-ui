...
export const FileMultipleIcon = injectSheet(styles)<SvgIconProps>((props: SvgIconProps & StyledComponentProps)=> (
  <SvgIcon {...props} viewBox='0 0 31 39'>
    <g id="💻-ID-Dashboard-multiple-files" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="multiple-files" transform="translate(-392.000000, -1692.000000)" stroke="#697C95" stroke-width="1.71428571">
