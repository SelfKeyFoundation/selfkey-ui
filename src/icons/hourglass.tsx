...
export const HourGlassIcon = withStyles(styles)(
	(props: SvgIconProps & WithStyles<typeof styles>) => (
		...
		>
			<g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
				<g
					id="5.-Style-Guide---UI-Elements"
					transform="translate(-643.000000, -394.000000)"
					fill="#697C95"
					fillRule="nonzero"
				>
