...
export const ListIcon = (props: SvgIconProps) => (
	<SvgIcon
		style={{ width: props.width || '32px', height: props.height || '16px' }}
		{...props}
		viewBox={props.viewBox || '0 0 32 16'}
	>
		<g id="🌈-UI-Guidelines" stroke="none" strokeWidth="1" fillRule="evenodd">
			<g
				id="3.-Style-Guide---Forms"
				transform="translate(-1098.000000, -863.000000)"
				fill="inherit"
			>
