...
export const MenuHelpIcon = injectSheet(styles)<SvgIconProps>((props: SvgIconProps & StyledComponentProps) => (
        <SvgIcon style={{ width: props.width || '16px', height: props.height || '19px' }} {...props} viewBox={props.viewBox || "0 0 16 19"}>
            <defs></defs>
            <g id="🖥-Main-Dashboard-mhi" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="300.4-Navigation-collapsed-mhi" transform="translate(-20.000000, -1263.000000)" fill="#93A4AF" fill-rule="nonzero">
                    <g id="Menu-mhi">
