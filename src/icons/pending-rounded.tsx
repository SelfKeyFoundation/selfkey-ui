...
export const PendingRoundedIcon = withStyles(styles)(
	(props: SvgIconProps & WithStyles<typeof styles>) => (
		...
		>
			<g id="🖥-Main-Dashboard" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
				<g
					id="300.7-dashboard-alternate1---full-state"
					transform="translate(-1049.000000, -681.000000)"
				>
...
export default PendingRoundedIcon;
