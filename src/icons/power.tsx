...
export const PowerIcon = injectSheet(styles)<SvgIconProps>((props: SvgIconProps & StyledComponentProps) => (
        <SvgIcon style={{ width: props.width || '16px', height: props.height || '16px' }} {...props} viewBox={props.viewBox || "0 0 16 16"}>
            <defs></defs>
            <g id="🖥-Main-Dashboard-pi" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="300.4-Navigation-collapsed-pi" transform="translate(-20.000000, -1366.000000)" fill="#93A4AF" fill-rule="nonzero">
                    <g id="Menu">
