...
export const SentNewIcon = injectSheet(styles)<SvgIconProps>((props: SvgIconProps & StyledComponentProps) => (
        <SvgIcon style={{ width: props.width || '34px', height: props.height || '34px' }} {...props} viewBox={props.viewBox || "0 0 34 34"}>
            <g id="Main-Dashboard-sent-new-icon" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="300.7-dashboard-alternate1--sent-new-icon" transform="translate(-1048.000000, -536.000000)">
