...
export const SimpleCheckIcon = withStyles(styles)(
	(props: SvgIconProps & WithStyles<typeof styles>) => (
		<SvgIcon
			style={{ width: props.width || '39px', height: props.height || '45px' }}
			{...props}
			viewBox={props.viewBox || '0 0 39 45'}
		>
			<title>icon-simple-check</title>
			<g
				id="💻-ID-Dashboard-simple-check"
				stroke="none"
				strokeWidth="1"
				fill="none"
				fillRule="evenodd"
