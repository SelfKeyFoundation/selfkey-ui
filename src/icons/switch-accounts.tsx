...
export const SwitchAccountsIcon = withStyles(styles)((props: SvgIconProps & WithStyles<typeof styles>) => (
    <SvgIcon style={{ width: props.width || '16px', height: props.height || '16px' }} {...props} viewBox={props.viewBox || "0 0 16 16"}>
        <g id="🖥-Main-Dashboard-sai" stroke="none" strokeWidth="1" fillRule="evenodd">
            <g id="300.4-Navigation-collapsed-sai" transform="translate(-20.000000, -1314.000000)">
                <g id="Menu">
