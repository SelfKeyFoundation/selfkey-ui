...
export const TransferIcon= withStyles(styles)((props: SvgIconProps & WithStyles<typeof styles>) => (
    <SvgIcon style={{ width: props.width || '26px', height: props.height || '26px' }} {...props} viewBox={props.viewBox || '0 0 489.2 489.2'}>
        <g>
