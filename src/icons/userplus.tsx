...
export const UserPlusIcon = withStyles(styles)(
	(props: SvgIconProps & WithStyles<typeof styles>) => (
		...
		>
			...
			>
				<g
					id="502-Exchange-Details-+-Not-Unlocked"
					transform="translate(-929.000000, -275.000000)"
					fill="#FFFFFF"
				>
