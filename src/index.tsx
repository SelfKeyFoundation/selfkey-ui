...
export { ExchangeRoundedIcon } from './icons/exchange-rounded';
...
export { ReceivedRoundedIcon } from './icons/received-rounded';
...
export { SentRoundedIcon } from './icons/sent-rounded';
