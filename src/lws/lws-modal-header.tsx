...
export const LWSModalHeader = withStyles(styles)(
	({ classes, closeAction }: LWSModalHeaderProps & WithStyles<typeof styles>) => (
		<div className={classes.root}>
			<SelfkeyLogo style={{ width: '50px', height: '43px' }} />
			<Typography variant="h1" className={classes.title}>
				Login with SelfKey
			</Typography>
			<button className={classes.closeButton} onClick={closeAction}>
				<CloseButtonIcon />
			</button>
		</div>
	)
