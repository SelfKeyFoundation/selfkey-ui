...
export class CryptoPriceTableComponent extends React.Component<StyledProps, CryptoPriceTableState> {
  ...
  render() {
    const {classes, locale, fiatCurrency, tokens, toggleAction } = this.props;
    return (
        ...
        <Table className={classes.table}>
            ...
            {tokens.map((token, index) => {
                ...
                <TableRow key={index} className={classes.bodyTableRow}>
                    ...
                    <TableCell numeric>
                        <PriceSummary className={classes.test} locale={locale} style="decimal" currency={token.symbol} value={token.balance} />
                    </TableCell>
                    <TableCell numeric>
                        <PriceSummary locale={locale} style="currency" currency={fiatCurrency} value={token.price} />
                    </TableCell>
                    <TableCell numeric>
                        <PriceSummary locale={locale} style="currency" currency={fiatCurrency} value={token.balanceInFiat} />
                    </TableCell>
