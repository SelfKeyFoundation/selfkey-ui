...
export const TransactionSendProgressBox= withStyles(styles)(
    ({ classes, cryptoCurrency, closeAction, amount, address, openLink, locale, status, transactionHash }: TransactionNoGasErrorProps & WithStyles<typeof styles>) => (
        <TransactionBox cryptoCurrency={cryptoCurrency} closeAction={closeAction}>
            <Grid container direction='row' justify='flex-start' alignItems='flex-start'>
                ...
                <Grid item xs={10}>
                    ...
                    <Grid item>
                        <Grid container>
                        <Grid container direction="row" justify="flex-start" alignItems="flex-start" className={classes.actionButtonsContainer} spacing={1}>
                            <Grid item>
