...
> {
	...
	get value() {
		return (
			this.props.value || this.state.value || this.props.defaultValue || this.avarageGasPrice
		);
	}
	get transactionFee() {
...
export const TransactionFeeSliderSelector = withStyles(styles)(
	TransactionFeeSliderSelectorComponent
);
