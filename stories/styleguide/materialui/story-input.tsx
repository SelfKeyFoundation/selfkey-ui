			...
			<div>
				...
				<Grid container spacing={24} direction="column">
					<Grid item>
						...
						<FormControlLabel control={<Checkbox color="primary" />} label="Unselected, Error" />

						<FormControlLabel control={<Checkbox color="primary" checked />} label="Selected, Error" />

						<FormControlLabel control={<Checkbox indeterminate checked />} label="Bulk" />

						<FormControlLabel control={<Checkbox disabled />} label="Unselected, Disabled" />

						<FormControlLabel control={<Checkbox disabled checked />} label="Selected, Disabled" />
					</Grid>
				</Grid>
